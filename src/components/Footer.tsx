    ...
    <footer className="relative border-t border-border mt-16 bg-card">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-foreground font-semibold mb-4">Browse by Genre</h4>
          ...
          <div>
            <h4 className="text-foreground font-semibold mb-4">Browse by Year</h4>
            <ul className="space-y-2">
              {years.map((year) => (
                <li key={year}>
                  <Link
          ...
          <div>
            <h4 className="text-foreground font-semibold mb-4">Popular Guides</h4>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/anime/naruto/filler-list"
                  className="text-muted-foreground hover:text-brand-orange text-sm transition-colors duration-200"
                >
                  Naruto Filler Guide
                </Link>
              </li>

...
CREATE TABLE "WatchOrder" (
    ...
    CONSTRAINT "WatchOrder_animeId_fkey" FOREIGN KEY ("animeId") REFERENCES "Anime" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "FillerMapping" (
    ...
    "fillerPercent" REAL NOT NULL DEFAULT 0,
    CONSTRAINT "FillerMapping_animeId_fkey" FOREIGN KEY ("animeId") REFERENCES "Anime" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "AnimeRelation" (
    ...
    CONSTRAINT "AnimeRelation_fromAnimeId_fkey" FOREIGN KEY ("fromAnimeId") REFERENCES "Anime" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "AnimeRelation_toAnimeId_fkey" FOREIGN KEY ("toAnimeId") REFERENCES "Anime" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "SEOPage" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "SEOPage_animeId_fkey" FOREIGN KEY ("animeId") REFERENCES "Anime" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
